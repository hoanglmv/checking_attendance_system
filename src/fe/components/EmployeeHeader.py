...
class EmployeeHeader(QtWidgets.QGroupBox):
    def __init__(self, parent=None):
        ...
        # Title
        self.EmployeeHeader_title = QtWidgets.QLabel("Nhân viên", self)
        self.EmployeeHeader_title.setMinimumSize(QtCore.QSize(120, 37))
        self.EmployeeHeader_title.setMaximumSize(QtCore.QSize(120, 37))
        self.EmployeeHeader_title.setStyleSheet("color: white; font: 18pt 'Times New Roman';")
        self.horizontalLayout.addWidget(self.EmployeeHeader_title)
